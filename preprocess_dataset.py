...
def parse_args():
    ...
    parser.add_argument('--origin-dir', default='/home/ubuntu/datasets/Counting/UCF-QNRF_ECCV18',
                        help='original data directory')
    parser.add_argument('--data-dir', default='/home/ubuntu/datasets/Counting/UCF-Train-Val-Test',
            ...
            for sub_phase in sub_phase_list:
                ...
                with open('{}.txt'.format(sub_phase)) as f:
                    for i in f:
                        ...
                        im_save_path = im_save_path.replace('img', 'IMG')
